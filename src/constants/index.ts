...
const features: { id: number, icon: string, highlight: string, text: string, styles: string }[] = [
    {
        id: 1,
...
const featureSequence: { videoPath: string, boxClass: string, delay: number }[] = [
...
const footerLinks: { label: string, link: string }[] = [
